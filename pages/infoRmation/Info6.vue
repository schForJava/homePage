    ...
    <el-row class="count">
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <span class="count1">PPN信息披露情况表（日终）</span>
        </div>
      </el-col>
    </el-row>
    <div class="container">
      ...
      <el-row class="topCentent" style="margin-top: 30px">
        <el-col :span="6">
          <label class="search-label">披露机构：</label>
          <el-input
            placeholder="请输入"
...
<script>
  import {getInfo6, getInfoSelect, getSysDate} from "../../library/api/api.public";
...
export default {
  ...
  methods: {
    ...
    derive() {
      ...
      let url =
        this.$api.IP + "/ppnPublish/downLoadHisExcel?chooseTime=" + this.timeValue;
      let param = {
