    ...
    <el-row class="count">
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <span class="count1">公开发行债券信息表（日中）</span>
        </div>
      </el-col>
    </el-row>
    <div class="container">
...
<script>
  import {getInfo2, getSysDate} from "../../library/api/api.public";
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      console.log(this.input.issueDate);
    ...
    derive() {
      ...
      let url =
        this.$api.IP +
        "/pubIssue/queryExportList?disSureTime=" +
        this.timeValue;
      let param = {
