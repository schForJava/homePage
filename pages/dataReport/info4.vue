    ...
    <el-row class="count">
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <span class="count1">集中簿记建档情况表格文件（报结算服务部）</span>
        </div>
      </el-col>
    </el-row>
    <div class="container">
      ...
      <h2 style="margin-top: 25px">{{ yearStr }}</h2>
      <div class="tables">
...
<script>
import { getSettlementList } from "../../library/api/api.public";
  ...
  methods: {
    ...
    getData() {
      ...
      getSettlementList(params).then((res) => {
        ...
        this.monthTableData = res.data.queryList;
